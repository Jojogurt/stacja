...
import { initMp, mpMe, mpBootDeepLink } from './app/mp.js';   // mp.js importuje social (router ekranów)
...
/* ============ MULTIPLAYER → app/mp.js ============ */
// wstrzyknij dane kategorii + wrappery związane z ALL_CATS (mp.js woła initSocial wewnątrz)
initMp({ ALL_CATS, ALL_KEYS, ERA_KEYS, STYLE_KEYS, READY_KEYS, LYRICS_KEYS, QUIZ_KEYS,
  catLabel, buildMatch, randomPools, plLoad, plFetch });
